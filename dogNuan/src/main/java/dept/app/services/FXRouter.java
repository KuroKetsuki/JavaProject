...
public final class FXRouter {
    ...
    private static String pathCss = "/dept/app/Theme/pastel.css";
    ...
    public static void setPathCss(String pathCss1){pathCss = pathCss1;}
    ...
    private static void loadNewRoute(RouteScene route) throws IOException {
        ...
        resource.getStylesheets().add(FXRouter.class.getResource(pathCss).toString());
